...
def test_init():
    space = Space(1, 'test space', 100, 'This is a test space.')
    assert space.id == 1
...
def test_spaces_are_equal():
    space = Space(1, 'test space', 100, 'This is a test space.')
    space_2 = Space(1, 'test space', 100, 'This is a test space.')
...
def test_make_it_a_string():
    space = Space(1, 'test space', 100, 'This is a test space.')
    assert str(space)== "Space(1, test space, 100, This is a test space.)"
